...
final class Version20251015120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, checkout_session_id VARCHAR(255) NOT NULL, amount_total INT DEFAULT NULL, currency VARCHAR(16) DEFAULT NULL, metadata JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', status VARCHAR(16) NOT NULL DEFAULT \'PENDING\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_E52FFDE161112094 (checkout_session_id), INDEX IDX_E52FFDE1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
